...
export default class Game2 extends Phaser.Scene {
    ...
    preload() {
        this.load.image('platform2', 'assets/ground_sand.png')
    ...
    create() {
        ...
        this.add.text(240, 0, 'Poziom 2 - natężenie prądu, amper [A]', {
            fontFamily: 'Bangers',
            fontSize: '24px',
            color: '#000'
        })
        ...
        this.add.text(this.scale.width * 0.5, this.scale.height * 0.25, 'NATĘŻENIE PRĄDU,\nAMPER', {
            fontFamily: 'Bangers',
            fontSize: '64px',
            color: '#000',
            align: 'center'
    ...
    update() {
        ...
        if(this.itemsCollected > 19) {
            this.cameras.main.fadeOut(1000);
            this.scene.start('game3', {itemsCollected: this.itemsCollected})
        }
    }
    ...
    addItemAbove(sprite) {
        ...
        const item = this.items.get(whereItem, y, 'bolt')
        item.setActive(true)
